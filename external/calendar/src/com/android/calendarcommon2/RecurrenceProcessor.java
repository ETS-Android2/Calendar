...
public class RecurrenceProcessor
{
    ...
    public long getLastOccurence(Time dtstart,
                                 RecurrenceSet recur) throws Exception {
...
bysetpos:
            ...
            events: {
                while (true) {
                    ...
                    while (true) {
                        ...
                        switch (freqField) {
                            case Time.SECOND:
                                iterator.plusSeconds(value);
                                break;
                            case Time.MINUTE:
                                iterator.plusMinutes(value);
                                break;
                            case Time.HOUR:
                                iterator.plusHours(value);
                                break;
                            case Time.MONTH_DAY:
                                iterator.plusDays(value);
                                break;
                            case Time.MONTH:
                                iterator.plusMonths(value);
                                break;
                            case Time.YEAR:
                                iterator.year += value;
                                break;
    ...
    static int weekDay(int year, int month, int day) {
        ...
        return ((day + (13 * month - 14) / 5 + year + year/4 - year/100 + year/400) % 7 + 7) % 7;
    }
