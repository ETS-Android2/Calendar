...
public class HourMinutePicker extends FrameLayout {
    ...
    public HourMinutePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        setSelectionDivider(new ColorDrawable(getContext().getColor(R.color.date_picker_divider_color)));
    }

    public void playSoundEffect() {
        MediaPlayer mediaPlayer = MediaPlayer.create(getContext(), R.raw.click2);
        mediaPlayer.start();
