 ...
 */
public class StandardMonthPagerAdapter extends RecyclerView.Adapter<StandardMonthPagerAdapter.ViewHolder> {
    Context mContext;
    ...
    public StandardMonthPagerAdapter(Context context, CalendarViewDelegate delegate, ViewPager2 viewPager) {
        mContext = context;
        mDelegate = delegate;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.standard_month_view_container, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        StandardMonthViewContainer view = (StandardMonthViewContainer) viewHolder.itemView;
    ...
    public void onViewDetachedFromWindow(@NonNull ViewHolder holder) {
        StandardMonthViewContainer view = (StandardMonthViewContainer) holder.itemView;
        view.setTransformAnimatorProgress(0);
