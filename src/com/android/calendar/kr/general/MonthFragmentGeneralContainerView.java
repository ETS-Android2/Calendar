 ...
 */
public class MonthFragmentGeneralContainerView extends LinearLayout {
    AllInOneActivity mMainActivity;
    boolean mAnimationStart = true;

    public MonthFragmentGeneralContainerView(Context context) {
        this(context, null);
    }

    public MonthFragmentGeneralContainerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MonthFragmentGeneralContainerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
